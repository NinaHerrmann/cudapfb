...
#endif
// _SIZE gives size of the sub-block as given in our article. It is calculated as ratio of DATA_SIZE and THREADS_PER_BLOCK rounded up so SUBBLOCK_SIZE=DATA_SIZE/THREADS_PER_BLOCK=2.6666, rounding up gives SUBBLOCK_SIZE=3;
#ifndef SUBBLOCK_SIZE
#define SUBBLOCK_SIZE 1
#endif
#ifndef OUTPUTWRITE
